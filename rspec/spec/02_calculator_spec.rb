...
describe "#multiply" do
  ...
  expect(multiply(3, 5)).to equal(15) end
  it "multiplies several numbers" do
  expect(multiply(multiply(2,3),5)).to equal(30) end
end
...
describe "#factorial" do
  ...
  it "computes the factorial of 1" do
	expect(factorial(1)).to equal(1) end
  it "computes the factorial of 2" do
	expect(factorial(2)).to equal(2) end 
  it "computes the factorial of 5" do 
	expect(factorial(5)).to equal(120) end
  it "computes the factorial of 10" do 
	expect(factorial(10)).to equal(3628800) end 
end
